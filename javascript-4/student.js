...
let faveColors = ['blue', 'brown', 'green']
...
let me = {
    ...
    homeTown: 'park city',
    superPowers: ['fly', 'teleport', 'spring fast'],
    // superPowerXP: Math.floor(Math.random() * 100) + 1
    profileImage: function(){ 
        this.profileImage = `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg`
}
}
